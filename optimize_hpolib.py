...
from targets.hpolib.api import ConstraintChoices, DatasetChoices, HPOBench
...
if __name__ == '__main__':
    ...
    file_name = get_filename_from_args('hpolib', constraints, args)
    ...
    if args.opt_name == 'hm':
        kwargs.update(hypermapper_json='targets/hpolib/hypermapper.json')
    if args.naive:
